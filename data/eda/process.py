...
def process(df_path, mrt_input_path, mrt_planned_input_path, mall_input_path, school_input_path, coe_path, stock_path, town_centroid_radius_input_path, out_path=None, save=False):
    ...
    df_with_town_centrality = extract_town_centrality(mrt_input_path, mrt_planned_input_path, mall_input_path, school_input_path, town_centroid_radius_input_path)
...
if __name__ == '__main__':
    ...
    test_clean = process(test_input_path, mrt_input_path, mrt_planned_input_path, mall_input_path, school_input_path, coe_input_path, stocks_input_path,town_centroid_radius_input_path, test_output_path, save_intermediate_df)
    print("test done")
